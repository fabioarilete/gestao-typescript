...
export const CardCustos = ({ id, name, preco, nf, icms, frete, unid, tipoFornecedor, total, handleRemove }: Props) => {
      ...
      <S.ContainerList>
        ...
        <S.ContainerInfo>
          <S.Container20>
            ...
            <S.P>{/* {formatCurrency(preco, 'BRL')} {unid} */}</S.P>
          </S.Container20>
          ...
          <S.Container20>
            ...
            <S.P>{/* {formatCurrency(total, 'BRL')} {unid} */}</S.P>
          </S.Container20>
        </S.ContainerInfo>
      </S.ContainerList>
    </S.Box>
